...
class Pet {
    lista() {
        const sql = 'SELECT pet.id, pet.nome, pet.tipo, pet.observacoes, clie.id as donoId, clie.nome as donoNome, clie.cpf as donoCpf ' +
            'FROM Pets pet ' +
            'JOIN Clientes clie ' +
            'ON pet.donoId = clie.id';
